                    ...
                    <table class="table table-hover table-sm tableStyle ">
                        ...
                        <tbody>
                            ...
                            <?php foreach (array_reverse($addinformations) as $key => $sample) : ?>
                                <?php
                                 if ($sample->current_Id == $_GET['idPage'] && $sample->customer_section_name != null) {
                                        $count += 1;                                     
                                }
                            ...
                            <?php foreach (array_reverse($addinformations) as $key => $sample) : ?>
                                ...
                                ?>
                                            <tr style="font-size:10.5px ;">
                                                ...
                                                <td> <a href="<?php echo add_query_arg(['z' => 'removeSection', 'sectionDelete' => $sample->customer_id, 'idPerson' => $idCp]) ?>"><span class="dashicons dashicons-trash"></span></a>
                                                </td>
                                            </tr>
                            <?php }
                                    }
